        ...
        <>
            <section id='contactus' className='w-10/12 mx-auto h-fit py-7'>
                ...
                <div className='flex gap-10 items-center max-sm:flex-wrap'>
                    ...
                    <div className='flex items-center gap-5'>
                        <Link href={'mailto:maunrasheed.dev@gmail.com'} className='bg-white p-2 rounded-full shadow-[5px_5px_7px_rgba(0,0,0,0.35)]'><Mail /></Link>
                        <div>
                            <h4 className='uppercase text-xl font-semibold'>Email</h4>
                            <Link href={'mailto:maunrasheed.dev@gmail.com'} className='hover:text-main-color transition-colors duration-500'>maunrasheed.dev@gmail.com</Link>
                        </div>
                    </div>
                    <div className='flex items-center gap-5'>
                        <Link href="https://wa.me/923286536520?text=Hi%20I%20want%20to%20hire%20you" className='bg-white p-2 rounded-full shadow-[5px_5px_7px_rgba(0,0,0,0.35)] transition-colors duration-500 hover:text-green-600'>
                            <svg
                                className="h-8 w-8"
                                fill="currentColor"
                        ...
                        <div>
                            <h4 className='uppercase text-xl font-semibold'>WhatsApp</h4>
                            <Link href="https://wa.me/923286536520?text=Hi%20I%20want%20to%20hire%20you" className='transition-colors duration-500 hover:text-green-600'>+92-3286536520</Link>
                        </div>
                    </div>
                </div>
            </section>
