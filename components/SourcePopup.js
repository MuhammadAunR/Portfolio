        ...
        <>
            <div className='fixed inset-0 bg-black/30 flex items-center justify-center z-50 backdrop-blur-lg'>
                <div className='bg-white w-125 h-fit py-10 px-10 rounded-2xl relative'>
                    <span onClick={props.close} className='absolute top-2 right-2 transform hover:rotate-180 hover:text-gray-600 transition-all cursor-pointer'>
                    ...
                    <div className='flex flex-col justify-center gap-5 items-center '>
                        ...
                        <p className='text-lg text-gray-600 text-center'>Sorry 😕, <br /> This project was developed under private constraints, so the codebase is not open for public viewing. Thank you for your consideration.</p>
                    </div>
                </div>
            </div>
        </>
