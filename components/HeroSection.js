                ...
                <section className='my-14 flex gap-7 items-center'>
                    ...
                    <div>
                        <div className='flex gap-4'>
                            ...
                            <div className='hover:scale-110 transition-transform ease-in-out duration-300'>
                                <Image src={'https://skillicons.dev/icons?i=js,react'} alt='html,css' width={100} height={50} unoptimized />
                            </div>
                            <div className='hover:scale-110 transition-transform ease-in-out duration-300'>
                                <Image src={'https://skillicons.dev/icons?i=nextjs'} alt='html,css' width={50} height={50} unoptimized />
                            </div>
                            <div className='hover:scale-110 transition-transform ease-in-out duration-300'>
                                <Image src={'https://skillicons.dev/icons?i=nodejs,expressjs'} alt='html,css' width={100} height={50} unoptimized />
                            </div>
                            <div className='hover:scale-110 transition-transform ease-in-out duration-300'>
                                <Image src={'https://skillicons.dev/icons?i=git,github'} alt='html,css' width={100} height={50} unoptimized />
                            </div>
                            <div className='hover:scale-110 transition-transform ease-in-out duration-300'>
                                <Image src={'https://skillicons.dev/icons?i=vercel,netlify'} alt='html,css' width={100} height={50} unoptimized />
                            </div>
                            <div className='hover:scale-110 transition-transform ease-in-out duration-300'>
                                <Image src={'https://skillicons.dev/icons?i=mongodb'} alt='html,css' width={50} height={50} unoptimized />
                            </div>
                            <div className='hover:scale-110 transition-transform ease-in-out duration-300'>
                                <Image src={'https://skillicons.dev/icons?i=cpp'} alt='html,css' width={50} height={50} unoptimized />
                            </div>
